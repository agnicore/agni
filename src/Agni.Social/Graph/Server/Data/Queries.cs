...
namespace Agni.Social.Graph.Server.Data
{
  internal static class Queries
  {
    ...
    public static Query<TRow> FindOneNodeByGDID<TRow>(GDID gNode) where TRow : Row
    {
    ...
    public static Query<TRow> ChangeInUseNodeByGDID<TRow>(GDID gNode, bool isDel) where TRow : Row
    {
    ...
    public static Query<TRow> CountSubscribers<TRow>(GDID gNode) where TRow : Row
    {
    ...
    public static Query<TRow> FindSubscriber<TRow>(SubscriberVolumeRow volume, GDID gSubscriber) where TRow:Row
    {
    ...
    public static Query<TRow> FindSubscriberVolumes<TRow>(GDID gNode) where TRow : Row
    {
    ...
    public static Query<TRow> CountSubscriberVolumes<TRow>(GDID gNode) where TRow : Row
    {
    ...
    public static Query<TRow> FindSubscribers<TRow>(GDID gVolume, long start, int count) where TRow : Row
    {
    ...
    public static Query<TRow> GetNextVolume<TRow>(GDID gNode, int start) where TRow : Row
    {
    ...
    public static Query<TRow> FindOneFriendByNodeAndFriend<TRow>(GDID gNode, GDID gFriendNode) where TRow : Row
    {
    ...
    public static Query<TRow> CountFriends<TRow>(GDID gNode) where TRow:Row
    {
    ...
    public static Query<TRow> FindFriendListByNode<TRow>(GDID gNode) where TRow : Row
    {
    ...
    public static Query<TRow> FindAllFriends<TRow>(GDID gNode) where TRow : Row
    {
    ...
    public static Query<TRow> GetNextFriend<TRow>(GDID gNode, int start) where TRow : Row
    {
    ...
    public static Query<TRow> FindNodeRating<TRow>(GDID gNode, string dimension) where TRow : Row
    {
    ...
    public static Query<TRow> FindNodeRatings<TRow>(GDID gNode, DateTime dt) where TRow :  Row
    {
    ...
    public static Query<TRow> FindCommentVolume<TRow>(GDID gNode, GDID gVolume) where TRow : Row
    {
    ...
    public static Query<TRow> FindEmptyCommentVolume<TRow>(GDID gNode, string dimension, int maxCount) where TRow : Row
    {
    ...
    public static Query<TRow> FindCommentByGDID<TRow>(GDID gComment) where TRow : Row
    {
    ...
    public static Query<TRow> FindComments<TRow>(GDID gNode, string dimension, bool isRoot) where TRow : Row
    {
    ...
    public static Query<TRow> HasCommentsCreatedByAuthor<TRow>(GDID gNode, GDID gAuthor, string dimension) where TRow : Row
    {
    ...
    public static Query<TRow> CountResponses<TRow>(CommentID commentId) where TRow: Row
    {
    ...
    public static Query<TRow> FindComplaints<TRow>(GDID gComment) where TRow : Row
    {
    ...
    public static Query<TRow> FindCommentVolumes<TRow>(GDID gNode, string dimension,int count, DateTime cdt) where TRow: Row
    {
