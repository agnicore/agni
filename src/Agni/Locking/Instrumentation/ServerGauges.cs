...
namespace Agni.Locking.Instrumentation
{
  /// <summary>
  ...
  public sealed class ServerLockTransactions : LockingServerGauge
  {
    ...
    public override string ValueUnitName { get { return NFX.CoreConsts.UNIT_NAME_TRANSACTION; } }
  ...
  public sealed class ServerEndLockSessionCalls : LockingServerGauge
  {
    ...
    public override string ValueUnitName { get { return NFX.CoreConsts.UNIT_NAME_CALL; } }
  ...
  public sealed class ServerRemovedEmptyTables : LockingServerGauge
  {
    ...
    public override string ValueUnitName { get { return NFX.CoreConsts.UNIT_NAME_TABLE; } }
