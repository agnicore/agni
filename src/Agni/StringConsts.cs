...
namespace Agni
{
  internal static class StringConsts
  {
    ...
    public const string INTERNAL_IMPLEMENTATION_ERROR = "Error in internal implementation: ";
   ...
   "Can not obtain sharding ID from object of type '{0}'";
    ...
    public const string MDB_POSSIBLE_SHARDING_ID_CYCLE_ERROR =
       "Can not obtain sharding ID because of possible cycle in IShardingProvider.ShardingID graph";
