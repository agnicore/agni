...
{
  public abstract class ProcessManagerBase : ServiceWithInstrumentationBase<IAgniApplication>, IProcessManagerImplementation
  {
    #region CONSTS
    ...
    #region .ctor
    public ProcessManagerBase(IAgniApplication director) : base(director)
    {
    ...
    public PID Allocate(string zonePath)
    {
      ...
      var gdid = AgniSystem.GDIDProvider.GenerateOneGDID(SysConsts.GDID_NS_WORKER, SysConsts.GDID_NAME_WORKER_PROCESS);
