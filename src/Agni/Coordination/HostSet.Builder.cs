    ...
    public class Builder
    {
      ...
      public static Builder Instance
      {
        get
        {
          ...
          {
            if(s_Instance!=null) return s_Instance;
            var node = AgniSystem.Metabase.RootConfig[Metabank.CONFIG_HOST_SET_BUILDER_SECTION];
      ...
      protected virtual IConfigSectionNode DoTryFindConfig(string setName, string clusterPath, bool searchParent, bool transcendNoc, out string actualPath)
      {
        ...
        Metabank.SectionRegionBase level = AgniSystem.Metabase.CatalogReg[clusterPath];
