...
namespace Agni.Metabase
{
    ...
    /// <summary>
    /// Provides interface to METABASE - a metadata bank for the Agni.
    ...
    ///           ..
    ///           /roleX
    ///   /bin - contains binary packages thatget installed on appropriate hosts
    ///       /package-name1.platform.os.version
    ///       ..
    ///       /package-nameX.platform.os.version
    ///   /reg - regional catalog, organizes hierarcies of regions, NOC(facilities), zones and hosts
    ///       /region1
    ///           /sub-region1
    ///                /noc1
    ///                    /zone1
    ...
    public sealed partial class Metabank : ApplicationComponent, IInstrumentable
    {
      ...
      #region .ctor
          ...
          public Metabank(IFileSystem fileSystem, FileSystemSessionConnectParams fsSessionParams, string rootPath) : base()
          {
              ...
              var cacheStore = new CacheStore("AC.Metabank");
              ...
              superceeded by the cacheStore.DefaultTableOptions below:
               */
      ...
      #region Fields
          ...
          //Invariant cluture ignore case comparer
