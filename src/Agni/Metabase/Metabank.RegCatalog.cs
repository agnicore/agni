    ...
    public sealed class RegCatalog : SystemCatalog
    {
      ...
      #region Public
         ...
         public override void Validate(ValidationContext ctx)
         {
           ...
           var here = AgniSystem.HostMetabaseSection.EffectiveGeoCenter;
           var allNOCs = AllNOCs.ToList();
           foreach(var noc in allNOCs)
           {
             if (noc.EffectiveGeoCenter.Equals(SysConsts.DEFAULT_GEO_LOCATION))
             ...
             output.Add(new MetabaseValidationMsg(MetabaseValidationMessageType.Info, this, noc,
                                     "Distance to '{0}' is {1}km".Args(AgniSystem.HostMetabaseSection.RegionPath,
