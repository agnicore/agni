...
namespace Agni.WebMessaging.Server
{
  ...
  public abstract class Channel : ServiceWithInstrumentationBase<WebMessageSystemService>
  {
    ...
    /// </summary>
    public abstract MsgChannelWriteResult Write(List<MsgSendInfo> deliveryList, int idx, string address, AgniWebMessage msg);
    ...
    /// </summary>
    public abstract AgniWebMessage FetchMailboxMessage(MailboxMsgID mid);
