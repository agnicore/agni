...
namespace Agni.Contracts
{
  ...
  /// </summary>
  public interface IAgniService { }

  /// <summary>
  /// Marker interface for service clients that get managed by ServiceClient class
  /// </summary>
  public interface IAgniServiceClient : IAgniService, IDisposable
  {
    /// <summary>
    ...
    /// For service clients which are based on Glue refer to NFX.Glue.ClientEndPoint.ReserveTransport
    /// </summary>
