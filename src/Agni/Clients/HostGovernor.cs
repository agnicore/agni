...
{
// This implementation needs @Agni.@Contracts.@IHostGovernorClient, so
// it can be used with ServiceClientHub class

  ///<summary>
  /// Client for glued contract Agni.Contracts.IHostGovernor server.
  /// Each contract method has synchronous and asynchronous versions, the later denoted by 'Async_' prefix.
  /// May inject client-level inspectors here like so:
  ///   client.MsgInspectors.Register( new YOUR_CLIENT_INSPECTOR_TYPE());
  ///</summary>
  public class HostGovernor : ClientEndPoint, @Agni.@Contracts.@IHostGovernorClient
  {
  ...
  #region Static Members
     ...
     static HostGovernor()
     {
         var t = typeof(@Agni.@Contracts.@IHostGovernor);
  ...
  #region .ctor
     ...
     {
       get { return typeof(@Agni.@Contracts.@IHostGovernor); }
     }
  ...
  #region Contract Methods
         ...
         ///<summary>
         /// Asynchronous invoker for  'Agni.Contracts.IHostGovernor.GetHostInfo'.
         /// This is a two-way call per contract specification, meaning - the server sends the result back either
