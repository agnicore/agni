...
namespace Agni
{
  ...
  public static class SysConsts
  {
    ...
    public static readonly LatLng DEFAULT_GEO_LOCATION = new LatLng("41.4996374,-81.6936649", "Cleveland, OH, USA");
  ...
  public sealed class SystemVarResolver : IEnvironmentVariableResolver
  {
    ...
    {
      Configuration.ProcesswideEnvironmentVarResolver = SystemVarResolver.s_Instance;
    }
