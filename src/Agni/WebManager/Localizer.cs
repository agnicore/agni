...
using Agni.WebManager.Controls;
using Agni.WebManager.Pages;
...
namespace Agni.WebManager
{
  ...
  public static class Localizer
  {
    ...
    static Localizer()
    {
      NFX.Wave.Client.RecordModelGenerator.DefaultInstance.ModelLocalization += recGeneratorLocalization;
    }
