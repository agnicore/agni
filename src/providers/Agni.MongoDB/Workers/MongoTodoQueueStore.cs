...
namespace Agni.Workers.Server.Queue
{
  ...
  public sealed class MongoTodoQueueStore : TodoQueueStore
  {
    ...
    {
      if (DisposeStarted || queue==null || correlationKey==null) return new TodoFrame();
    ...
    {
      if (DisposeStarted || queue==null) return Enumerable.Empty<TodoFrame>();
    ...
    {
      if (DisposeStarted || queue==null || !todo.Assigned) return;
    ...
    {
      if (DisposeStarted || queue==null || todo==null) return;
